...
int main(int argc, char **argv)
{
    ...
    image_transport::CameraPublisher image_pub = main_cam_image.advertiseCamera(MVS_cap.rostopic_name.c_str(), 1000);
    ...
    while (ros::ok())
    {
        ...
        if (waitKey(1) == 27)
        {
            imwrite("/home/algorithm/ws_LidarStation_new_24/" + to_string(count) + ".png", src);
            count++;
            cout << "saved" << endl;
        }
#endif
